    ...
    return (
        <footer className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500">
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
                <div className="md:max-w-96">
                    ...
                    <p className="mt-6 text-sm">
                        Experience the power of AI with Toolkit.ai 
                    ...
                    <div>
                        ...
                        <div className="text-sm space-y-2">
                            ...
                            <div className="flex items-center gap-2 pt-4">
                                ...
                                <button className="bg-primary text-white w-24 h-9 rounded">Subscribe</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <p className="pt-4 text-center text-xs md:text-sm pb-5">
                Copyright 2025 © <a href="https://personal-portfolio-q9lq.vercel.app/">MinishaLincy</a>. All Right Reserved.
            </p>
        </footer>
    );
};