      ...
      >
        ...
        <div className='my-6 flex items-center gap-2 '>
          <label className='relative cursor-pointer'>
            ...
            <div className='w-9 h-5 bg-slate-300 rounded-full peer-checked:bg-[#0e2e72] transition '></div>
      ...
      <div className="w-full p-4 bg-white rounded-lg flex flex-col border border-gray-300 min-h-96 ">
        ...
        {!content ? (
          ...
          <div className="text-sm flex flex-col items-center gap-5 text-gray-400">
            <Image className="w-9 h-9 text-primary opacity-60" />
          ...
          <div className='mt-3 h-full'>
            <img src={content} alt="image" className='
            w-full h-full' />
          </div>
        )
        }
